...
from mkTPFL.ckks.ckks_encoder import *
from mkTPFL.utils.class_transformer import DataKey, data2Obj
...
class CKKSEncryptor:
    ...
    def __init__(self, params, public_key):
        ...
        """
        if isinstance(public_key, DataKey):
            public_key = data2Obj(public_key, 'Key')
