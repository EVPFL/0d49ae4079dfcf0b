...
import torch
import time
from fedAvg.models.client import Client
from fedAvg.utils.worker_utils import Metrics
from fedAvg.models.worker import Worker
    ...
    def aggregate(self, solns, **kwargs):
        ...
        if self.simple_average:
            ...
            for num_sample, local_solution in solns:
                ...
                sample_sums += num_sample
            averaged_solution /= sample_sums
