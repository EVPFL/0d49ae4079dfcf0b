...
def main():
    ...
    # all types (i.e., '1' to '10') have the same number of samples: mnist_traindata & mnist_testdata
    # the dataset saves into a list, a element of which is 20 samples: split_mnist_traindata & split_mnist_testdata
    mnist_traindata = []
